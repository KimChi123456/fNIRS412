function varargout = GUI_offline1_Khanh(varargin)
% GUI_OFFLINE1_KHANH MATLAB code for GUI_offline1_Khanh.fig
%      GUI_OFFLINE1_KHANH, by itself, creates a new GUI_OFFLINE1_KHANH or raises the existing
%      singleton*.
%
%      H = GUI_OFFLINE1_KHANH returns the handle to a new GUI_OFFLINE1_KHANH or the handle to
%      the existing singleton*.
%
%      GUI_OFFLINE1_KHANH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_OFFLINE1_KHANH.M with the given input arguments.
%
%      GUI_OFFLINE1_KHANH('Property','Value',...) creates a new GUI_OFFLINE1_KHANH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_offline1_Khanh_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_offline1_Khanh_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_offline1_Khanh

% Last Modified by GUIDE v2.5 06-Apr-2015 16:01:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_offline1_Khanh_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_offline1_Khanh_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_offline1_Khanh is made visible.
function GUI_offline1_Khanh_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_offline1_Khanh (see VARARGIN)
global filename
clc
...
% Choose default command line output for GUI_offline1_Khanh
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_offline1_Khanh wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_offline1_Khanh_OutputFcn(hObject, eventdata, handles) 
