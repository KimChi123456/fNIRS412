function varargout = GUI_offline2(varargin)
% GUI_OFFLINE2 MATLAB code for GUI_offline2.fig
%      GUI_OFFLINE2, by itself, creates a new GUI_OFFLINE2 or raises the existing
%      singleton*.
%
%      H = GUI_OFFLINE2 returns the handle to a new GUI_OFFLINE2 or the handle to
%      the existing singleton*.
%
%      GUI_OFFLINE2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_OFFLINE2.M with the given input arguments.
%
%      GUI_OFFLINE2('Property','Value',...) creates a new GUI_OFFLINE2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_offline2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_offline2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUI_offline2

% Last Modified by GUIDE v2.5 25-Jan-2015 15:03:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUI_offline2_OpeningFcn, ...
                   'gui_OutputFcn',  @GUI_offline2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUI_offline2 is made visible.
function GUI_offline2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUI_offline2 (see VARARGIN)
global filename
clc
...
% Choose default command line output for GUI_offline2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUI_offline2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUI_offline2_OutputFcn(hObject, eventdata, handles) 
...
sav_data=[];
if save_check==0;
    sav_data=[raw sav_data1 sav_data2 sav_data3 sav_data4 sav_data5 sav_data6];
